...
If your website is hosted remotely or your Docker allows you to connect to the host network, you can run Muffet in a Docker image to test your websites.
